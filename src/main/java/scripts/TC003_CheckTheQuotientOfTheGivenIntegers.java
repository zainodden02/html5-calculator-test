...
public class TC003_CheckTheQuotientOfTheGivenIntegers extends DriverSetup {

    private final JSONObject data = FileUtil.loadJSON("TC-003.json");
    ...
    public void TC003() throws Exception {
        ...
        // EXPECTED TOTAL VALUE IS: 772.5
        double total = Calculator.divide(values);
        logger.info("The quotient of the given values is {}.", total);
